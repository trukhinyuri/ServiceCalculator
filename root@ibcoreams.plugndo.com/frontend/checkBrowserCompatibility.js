(function () {
    if (esx.detectVersion() < 5) {
        var moveToRequestPage = confirm("Пожалуйста, установите современную версию веб-браузера с поддержкой EcmaScript 5 для корректной работы калькулятора.\n\n" +
